...
A modern, Material 3–inspired audio streaming experience—focused, minimal, and built for people who want **audio-only YouTube playback** without the bloat.

Audifier is a refined fork of an “Audio Streaming Platform,” redesigned with a cleaner UI, smoother UX, and extra features that make listening effortless.
...
You can download the most recent build of Audifier from: [Download Latest APK](https://limewire.com/d/pmawk#Yu0albe9EQ)
---
...
If you'd like to add features, fix bugs, or improve the UI/UX, feel free to submit a pull request.
